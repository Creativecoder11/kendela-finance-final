...
//   return (
//     <div
//       className="herosection lg:-mt-26 md:-mt-28 -mt-28 md:pt-20 pt-20 lg:min-h-[101vh] md:min-h-[700px] min-h-[660px] flex flex-col items-center justify-center p-4 sm:p-8 overflow-hidden overflow-y-hidden"
//       style={{
...
import React, { useState, useEffect } from "react";
import { usePopup } from "../Hook/PopupContext";
// Import images with proper path
import BGImageDesktop from "../assets/Images/Header Banner BG.svg";
import BGImageTablet from "../assets/Images/heademobiletabletbg.webp";
import BGImageMobile from "../assets/Images/heademobiletabletbg.webp";
import Avater1 from "../assets/Icon/Avater 1.svg";
...
const HeroSection = () => {
  ...
  // Set fallback color that matches your design
  const fallbackColor = "#502B9E";

  // Early define background images map
  ...
  // Set device type on initial load and resize
  useEffect(() => {
    updateDeviceType();
  ...
  return (
    <div
      className="herosection lg:-mt-26 md:-mt-28 -mt-28 md:pt-20 pt-20 lg:min-h-[101vh] md:min-h-[700px] min-h-[660px] flex flex-col items-center justify-center p-4 sm:p-8 overflow-hidden overflow-y-hidden"
      style={{
        backgroundColor: fallbackColor, // Show immediately while image loads
        backgroundImage: `url(${backgroundImages[currentDevice]})`,
        backgroundSize: 'cover',
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat",
