    ...
    >
      ...
      <div className="text-center text-white max-w-xl">
        <div className="flex justify-center gap-3 mb-4">
          <span className="px-3 py-1 bg-[#EFE9FC] text-purple-700 rounded-full text-sm">
            Free to join
          </span>
          <span className="px-3 py-1 bg-[#EFE9FC] text-purple-700 rounded-full text-sm">
          Priority access
        ...
        <div className="flex flex-col mt-6 sm:flex-row gap-3 md:gap-4 max-w-lg sm:max-w-lg md:max-w-sm mx-auto">
          <input
            ...
            className="w-full flex-1 px-4 sm:px-6 py-2 sm:py-2 text-md rounded-full bg-white bg-opacity-40 text-white placeholder-purple-200 focus:outline-none focus:ring-2 focus:ring-white"
          />
          <button className="w-full sm:w-auto mt-2 sm:mt-0 px-2  sm:px-5 py-4 sm:py-3 rounded-full bg-(--color-purpel) text-sm text-white hover:shadow-lg transition transform hover:-translate-x-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
            Join waitlist
          </button>
        </div>
      </div>
