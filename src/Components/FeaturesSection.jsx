...
import flexImage from "../assets/Images/Flexi Splits.svg";
import currencyImage from "../assets/Images/Multi -Currency 1.svg";
import aiPowered from "../assets/Images/Ai Powered.svg";
import cardImage from "../assets/Images/cards.svg";
import savings from "../assets/Images/saving.svg";
...
export default function FeaturesSection() {
  ...
  useEffect(() => {
    const preloadImages = () => {
      const imagePromises = featureImages.map(src => {
    ...
    return () => {
      ...
      document.querySelectorAll('link[rel="preload"][as="image"]').forEach(link => {
        if (featureImages.includes(link.href)) {
  ...
  // Reusable image component with lazy loading and fade-in effect
